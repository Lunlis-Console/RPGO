...
public class ItemRollConfig
{
    ...
    /// <summary>Вес качества «Необычный» (относительный шанс; остаток — Обычный).</summary>
    public int WeightUncommon { get; set; }

    /// <summary>Вес качества «Редкий» (относительный шанс; остаток — Обычный).</summary>
    public int WeightRare { get; set; }

    /// <summary>Вес качества «Эпический» (относительный шанс; остаток — Обычный).</summary>
