...
{
    private static readonly Dictionary<GameMessageType, Action<GameClient, GameMessage>> _handlers = new()
    {
        [GameMessageType.AuthResponse] = HandleAuthResponse,
        [GameMessageType.Welcome] = HandleWelcome,
        [GameMessageType.Changelog] = HandleChangelog,
        [GameMessageType.MapUpdate] = HandleMapUpdate,
        [GameMessageType.EntityState] = HandleEntityState,
        [GameMessageType.Chat] = HandleChat,
        [GameMessageType.Error] = HandleError,
        [GameMessageType.StatusResponse] = HandleStatusResponse,
        [GameMessageType.InspectResponse] = HandleInspectResponse,
        [GameMessageType.InventoryResponse] = HandleInventoryResponse,
        [GameMessageType.QuestLog] = HandleQuestLog,
        [GameMessageType.ZoneTransition] = HandleZoneTransition,
        [GameMessageType.SectorData] = HandleSectorData,
        [GameMessageType.SectorsReloaded] = HandleSectorsReloaded,
        [GameMessageType.ShopResponse] = HandleShopResponse,
        [GameMessageType.ShopUpdate] = HandleShopResponse,
        [GameMessageType.TradeOpen] = HandleTradeOpen,
        [GameMessageType.TradeOfferUpdate] = HandleTradeOfferUpdate,
        [GameMessageType.TradeConfirmUpdate] = HandleTradeConfirmUpdate,
        [GameMessageType.TradeComplete] = HandleTradeComplete,
        [GameMessageType.TradeClose] = HandleTradeClose,
        [GameMessageType.TradeDeclined] = HandleTradeDeclined,
        [GameMessageType.DialogueOpen] = HandleDialogueOpen,
        [GameMessageType.DialogueClose] = HandleDialogueClose,
        [GameMessageType.Damage] = HandleDamage,
        [GameMessageType.Heal] = HandleHeal,
        [GameMessageType.ManaRegen] = HandleManaRegen,
        [GameMessageType.PlayerDeath] = HandlePlayerDeath,
        [GameMessageType.CombatState] = HandleCombatState,
        [GameMessageType.TargetDebuffUpdate] = HandleTargetDebuffUpdate,
        [GameMessageType.CancelTarget] = HandleCancelTarget,
        [GameMessageType.TargetCleared] = HandleCancelTarget,
        [GameMessageType.PartyInviteSent] = HandlePartyInviteSent,
        [GameMessageType.PartyInviteDeclined] = HandlePartyInviteDeclined,
        [GameMessageType.TradeRequestSent] = HandleTradeRequestSent,
        [GameMessageType.PartyUpdate] = HandlePartyUpdate,
        [GameMessageType.PartyDisbanded] = HandlePartyDisbanded,
        [GameMessageType.PartyInviteReceived] = HandlePartyInviteReceived,
        [GameMessageType.InstanceWindowOpen] = HandleInstanceWindowOpen,
        [GameMessageType.InstanceList] = HandleInstanceList,
        [GameMessageType.InstanceInviteReceived] = HandleInstanceInviteReceived,
        [GameMessageType.InstanceInviteUpdate] = HandleInstanceInviteUpdate,
        [GameMessageType.InstanceStarted] = HandleInstanceStarted,
        [GameMessageType.TradeRequestReceived] = HandleTradeRequestReceived,
        [GameMessageType.SkillsResponse] = HandleSkillsResponse,
        [GameMessageType.HotbarUpdate] = HandleHotbar,
        [GameMessageType.HotbarResponse] = HandleHotbar,
        [GameMessageType.LootCorpse] = HandleLootCorpse,
        [GameMessageType.BoardOpen] = HandleBoardOpen,
        [GameMessageType.OpenBoard] = HandleBoardOpen,
        [GameMessageType.EnhancementOpen] = HandleEnhancementOpen,
        [GameMessageType.FriendList] = HandleFriendList,
        [GameMessageType.FriendResult] = HandleFriendResult,
        [GameMessageType.AttackCooldown] = HandleAttackCooldown,
        [GameMessageType.SkillCooldown] = HandleAttackCooldown,
        [GameMessageType.ProjectileSpawn] = HandleProjectileSpawn,
        [GameMessageType.PlayerAttack] = HandlePlayerAttack,
        [GameMessageType.PlayerFacing] = HandlePlayerFacing,
        [GameMessageType.ProjectileHit] = HandleProjectileHit,
        [GameMessageType.MailList] = HandleMailList,
        [GameMessageType.MailDetail] = HandleMailDetail,
        [GameMessageType.MailUnread] = HandleMailUnread,
        [GameMessageType.MailResult] = HandleMailResult,
        [GameMessageType.StorageOpen] = HandleStorageOpen,
        [GameMessageType.StorageUpdate] = HandleStorageUpdate,
        [GameMessageType.CharacterList] = HandleCharacterList,
    };
    ...
    private static LootItemInfo ParseLootItem(JsonElement el)
    {
        ...
        return new LootItemInfo
        {
            ...
            BonusAccuracy = D("BonusAccuracy"), BonusTenacity = D("BonusTenacity"),
            BonusArmorPenetration = D("BonusArmorPenetration"), BonusCooldownReduction = D("BonusCooldownReduction"),
            BonusHpRegen = D("BonusHpRegen"), BonusMpRegen = D("BonusMpRegen"),
