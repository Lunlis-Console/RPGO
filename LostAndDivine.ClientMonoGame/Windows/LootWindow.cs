...
#pragma warning restore CS0414
    ...
    private Item ToItem(LootItemInfo info)
    {
        return new Item
        {
            ...
            BonusParryChance = info.BonusParryChance, BonusAccuracy = info.BonusAccuracy,
            BonusTenacity = info.BonusTenacity, BonusArmorPenetration = info.BonusArmorPenetration,
            BonusCooldownReduction = info.BonusCooldownReduction, BonusHpRegen = info.BonusHpRegen,
            BonusMpRegen = info.BonusMpRegen, DamageType = info.DamageType,
