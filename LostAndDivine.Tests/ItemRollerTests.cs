...
public class ItemRollerTests
{
    ...
    {
        var tpl = Template(ItemQuality.Common, 10, Config(0, 0, 0, 1, 1, ("Strength", 2, 2)));
        var result = ItemRoller.Roll(tpl, new Random(42));
    ...
    {
        var tpl = Template(ItemQuality.Common, 5, Config(0, 7, 0, 1, 1, ("Strength", 2, 2)));
    ...
    {
        var tpl = Template(ItemQuality.Common, 1, Config(0, 0, 9, 1, 1, ("Strength", 3, 3)));
        var result = ItemRoller.Roll(tpl, new Random(1));
    ...
    {
        // 30/15/5 → возможны только Необычный/Редкий/Эпический/Обычный, никогда не выйдет ничего другого
        var tpl = Template(ItemQuality.Common, 1, Config(30, 15, 5, 1, 1, ("Strength", 1, 1)));
    ...
    {
        var tpl = Template(ItemQuality.Common, 5, Config(30, 15, 5, 1, 1, ("Strength", 2, 2)));
    ...
    {
        var tpl = Template(ItemQuality.Common, 5, Config(0, 0, 9, 0, 0, ("Strength", 2, 4)));
        var result = ItemRoller.Roll(tpl, new Random(1));
    ...
    {
        var tpl = Template(ItemQuality.Common, 3, Config(0, 0, 9, 1, 3,
    ...
    {
        var tpl = Template(ItemQuality.Common, 10, Config(0, 0, 9, 2, 3,
    ...
    {
        var tpl = Template(ItemQuality.Common, 5, Config(0, 0, 9, 1, 1, ("Strength", 1.5, 1.5)));
        var result = ItemRoller.Roll(tpl, new Random(1));
    ...
    {
        var tpl = Template(ItemQuality.Common, 3, Config(0, 0, 9, 1, 1, ("CritChance", 1.35, 1.35)));
        var result = ItemRoller.Roll(tpl, new Random(1));
