...
public class AddBowSkillPath : ForwardOnlyMigration
{
    public override void Up()
    {
        ...
        Insert.IntoTable("skills").Row(new
        {
            ...
            description = "Меткий выстрел из лука. Урон 125% от базы. Только с луком. Ранг повышает урон и снижает КД.",
            type = "Лук · Акт",
            mp_cost = 5,
            cooldown_ms = 4000,
        ...
        Insert.IntoTable("skills").Row(new
        {
            ...
            description = "1 меткий выстрел разрывает сухожилие. Урон 110% от базы, накладывает Обездвижен. Только с луком.",
            type = "Лук · Акт",
            mp_cost = 12,
            cooldown_ms = 12000,
