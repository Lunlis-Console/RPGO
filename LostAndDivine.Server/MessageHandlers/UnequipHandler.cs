...
{
    public UnequipHandler(GameServices svc) : base(svc) { }
    ...
    public override async Task Handle(ClientConnection connection, GameMessage message, Player? player)
    {
        ...
        if (item == null)
        {
            await SendError(connection, ErrorCodes.SlotEmpty, "���� ���� � ������ �������.");
            return;
        }
        ...
        Log.Debug($"{player.Name} ���� {item.Name}");
        await SendToClient(connection, new GameMessage
        {
            Type = "chat",
            Data = new { Name = "�������", Text = $"�� ����� {item.Name}" }
        });
